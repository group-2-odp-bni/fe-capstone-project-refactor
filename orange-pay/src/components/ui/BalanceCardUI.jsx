...
export const ActionIcon = ({ label, children, to }) => (
  <Link
    to={to}
    className="flex flex-col items-center hover:text-white/90 transition-all cursor-pointer active:scale-[.98]"
  >
...
export const CTASection = ({ links }) => (
  ...
  >
    ...
    <div className="flex space-x-6 md:space-x-8 text-white">
      ...
      <ActionIcon
        to={links.addbalancefromwallet}
        label="Add Balance From Other Wallet"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="currentColor"
