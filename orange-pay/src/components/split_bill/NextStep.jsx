...
export default function NextStep({ image, onRetake, onConfirm }) {
  ...
  return (
    <div className="min-h-screen w-full bg-white flex flex-col relative overflow-hidden">
      ...
      {/* Preview Image - Dynamic aspect ratio */}
      <div className="flex-1 flex items-center justify-center px-4 py-6 relative z-10">
        <div 
          ...
          style={{
            aspectRatio: imageAspect.toString(),
        ...
        >
          ...
          <div className="absolute inset-0 pointer-events-none">
            <svg className="absolute inset-4 w-[calc(100%-32px)] h-[calc(100%-32px)]" viewBox="0 0 100 100" preserveAspectRatio="none">
              <path d="M 0,12 L 0,0 L 12,0" stroke="url(#gradient2)" strokeWidth="2" fill="none" strokeLinecap="round" />
              <path d="M 88,0 L 100,0 L 100,12" stroke="url(#gradient2)" strokeWidth="2" fill="none" strokeLinecap="round" />
              <path d="M 0,88 L 0,100 L 12,100" stroke="url(#gradient2)" strokeWidth="2" fill="none" strokeLinecap="round" />
              <path d="M 100,88 L 100,100 L 88,100" stroke="url(#gradient2)" strokeWidth="2" fill="none" strokeLinecap="round" />
        ...
        <div className="max-w-md mx-auto">
          <button
            ...
            className="w-full h-14 bg-gradient-to-r from-[#FF9A25] to-[#FF9A25]
                       ...
                       rounded-2xl shadow-xl shadow-[#FF9A25]/40
                       hover:shadow-2xl hover:shadow-[#FF9A25]/60
